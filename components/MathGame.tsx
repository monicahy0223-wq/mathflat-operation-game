        ...
        <div className="w-full max-w-2xl flex flex-col items-center gap-3">
          ...
          {reviewQ && (
            ...
            >
              ...
              {/* Input + keypad — centred at max-w-lg within the wider card */}
              <div className="px-4 pb-5 flex flex-col gap-3 max-w-lg mx-auto">
                ...
                <input
                  ...
                  style={{
                    ...KEYPAD_THEME_STYLES["review"].display,
                    fontSize: "clamp(1.6rem,6vw,2rem)",
                    padding: "14px",
                    borderColor: input
                      ? KEYPAD_THEME_STYLES["review"].glow
                      : "rgba(139,92,246,0.35)",
                    boxShadow: input
                      ? `0 0 0 3px ${KEYPAD_THEME_STYLES["review"].glow}33`
                      : "none",
                  }}
                />
      ...
      <div className="w-full max-w-2xl flex flex-col gap-3">
        ...
        >
          ...
          <div className="px-4 pb-5 flex flex-col gap-3">
            {/* 답 표시창 (readonly — 키패드 or 물리 키보드로 입력) */}
            <input
              ref={inputRef}
              type="text"
              readOnly
              className="w-full rounded-2xl border-[3px] focus:outline-none px-4 text-center font-black transition-all"
              style={{
                ...KEYPAD_THEME_STYLES[gameMode].display,
                fontSize: "clamp(2rem,7vw,2.8rem)",
                padding: "16px",
                borderColor: input
                  ? KEYPAD_THEME_STYLES[gameMode].glow
                  : "rgba(199,210,254,0.6)",
                boxShadow: input
                  ? `0 0 0 4px ${KEYPAD_THEME_STYLES[gameMode].glow}33`
                  : "none",
              }}
              value={input}
              onKeyDown={(e) => {
        ...
        <p className="text-center text-xs font-bold opacity-40 pb-2" style={{ color: typeInfo.groundColor }}>
          키보드로도 입력할 수 있어요 ⌨️
        </p>
      </div>
    </main>
